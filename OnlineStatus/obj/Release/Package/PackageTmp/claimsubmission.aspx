...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent1" runat="server">
	...
	adjustSize();
            ...
            <Columns>
                <dx:GridViewCommandColumn VisibleIndex="1" ButtonType="Image" Width="60px" 
	...
	adjustSize();
            ...
            <Columns>
                <dx:GridViewCommandColumn VisibleIndex="1" ButtonType="Image" Width="60px" Caption="Edit" FixedStyle="Left">
                    <EditButton Visible="True">
                        <Image Url="~/images/edit.png">
                        </Image>
                    </EditButton>
            ...
            </Columns><SettingsBehavior ColumnResizeMode="Control"></SettingsBehavior>
            <SettingsPager Mode="ShowAllRecords" PageSize="25" RenderMode="Lightweight">
            </SettingsPager>
            <SettingsEditing Mode="Inline" />
            <Settings ShowFilterRowMenu="True" ShowHeaderFilterButton="True"
	...
	adjustSize();
                       ...
                       adjustSize();
                                ...
                                <Columns>
                                    <dx:GridViewCommandColumn ButtonType="Image" Caption="Edit" FixedStyle="Left" ShowInCustomizationForm="True" VisibleIndex="1" Width="60px">
                                        <EditButton Visible="True">
                                            <Image Url="~/images/edit.png">
                                            </Image>
                                        </EditButton>
