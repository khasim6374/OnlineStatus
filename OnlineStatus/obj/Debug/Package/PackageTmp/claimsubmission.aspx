...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent1" runat="server">
    ...
    <div style="background-color: white">
        ...
        <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="0" 
            ...
            Width="100%" OnHtmlDataCellPrepared="grdClaimSubmissionPending_HtmlDataCellPrepared" OnStartRowEditing="grdClaimSubmissionPending_StartRowEditing">
	...
	adjustSize();
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="CreditStatus" Caption="Recovery Status" VisibleIndex="14" ExportWidth="65" ToolTip="Credit Status">
                    <EditItemTemplate>
                        <asp:Label ID="LabelRS" runat="server" Text='<%# Eval("CreditStatus") %>'></asp:Label>
                    </EditItemTemplate>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Claim Status" VisibleIndex="15" 
            ...
            <SettingsCookies CookiesID="grdclaimPending0912" StoreControlWidth="True" Version="16" Enabled="True" />
            <Styles>
            ...
            Width="100%" OnHtmlDataCellPrepared="grdClaimSubmission_HtmlDataCellPrepared">
            <ClientSideEvents Init="function(s, e) {
                       adjustSize();
	...
	adjustSize();
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="CreditStatus" Caption="Recovery Status" VisibleIndex="14" ExportWidth="65" ToolTip="Credit Status">
                    <EditItemTemplate>
                        <asp:Label ID="LabelRS1" runat="server" Text='<%# Eval("CreditStatus") %>'></asp:Label>
                    </EditItemTemplate>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Claim Status" VisibleIndex="15" 
                    ToolTip="Revenew Status" Caption="Revenew Status">
            ...
            <Styles>
                ...
                <dx:TabPage Text="Accepted Claims">
                    <ContentCollection>
                        <dx:ContentControl runat="server" SupportsDisabledAttribute="True">
                            <dx:ASPxGridView OnHtmlDataCellPrepared="grdClaimSubmissionAccepted_HtmlDataCellPrepared" ID="grdClaimSubmissionAccepted" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDS" KeyFieldName="Claim_ID" Width="100%" ClientInstanceName="grdClaimSubmissionAccepted">
                                <TotalSummary>
                <dx:ASPxSummaryItem DisplayFormat="Total Claim ={0}" FieldName="Claim_ID"
                    SummaryType="Count" />
                <dx:ASPxSummaryItem DisplayFormat="Total Claim Amount ={0:c2}" FieldName="Claim Amount"
                ...
                <dx:GridViewDataTextColumn FieldName="CreditStatus" Caption="Recovery Status" VisibleIndex="14" ExportWidth="65" ToolTip="Credit Status">
                    <EditItemTemplate>
                        <asp:Label ID="LabelRS2" runat="server" Text='<%# Eval("CreditStatus") %>'></asp:Label>
                    </EditItemTemplate>
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Claim Status" VisibleIndex="15" ToolTip="Revenew Status" Caption="Revenew Status">
                    <EditItemTemplate>
                        <asp:Label ID="Label17" runat="server" Text='<%# Eval("[Claim Status]") %>'></asp:Label>
                    </EditItemTemplate>
                </dx:GridViewDataTextColumn>
                ...
                <dx:TabPage Text="All Claims">
                    <ContentCollection>
                        <dx:ContentControl runat="server">
                            <dx:ASPxGridView OnHtmlDataCellPrepared="grdClaimSubmissionAll_HtmlDataCellPrepared" ID="grdClaimSubmissionAll" runat="server" AutoGenerateColumns="False" ClientIDMode="Static" ClientInstanceName="grdClaimSubmissionAll" DataSourceID="SqlDS" KeyFieldName="Claim_ID" Width="100%">
	...
	adjustSize();
                       ...
                       adjustSize();
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="CreditStatus" Caption="Recovery Status" VisibleIndex="14" ExportWidth="65" ToolTip="Credit Status">
                                        <EditItemTemplate>
                                            <asp:Label ID="LabelRS3" runat="server" Text='<%# Eval("CreditStatus") %>'></asp:Label>
                                        </EditItemTemplate>
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="Claim Status" ShowInCustomizationForm="True" ToolTip="Revenew Status" Caption="Revenew Status" VisibleIndex="15">
                                        <EditItemTemplate>
